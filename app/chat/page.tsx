...
// Add these new interfaces and constants near the top with other interfaces
interface AnimatedTextProps {
  texts: string[];
  interval?: number;
}

const rotatingTexts = ['Woodworking ?', 'DIY Projects', 'Wood Finishing', 'Tool Usage'];
...
const ProductCard = ({ product }: { product: Product }) => {
  return (
    <a
      ...
      className="flex-none bg-white dark:bg-gray-700 rounded-lg border min-w-[180px] px-4 py-3 hover:bg-gray-50 dark:hover:bg-gray-600 transition-colors"
    >
...
const FixedMarkdownRenderer = ({ content }: { content: string }) => (
  <ReactMarkdown
    ...
    components={{
      root: ({ children, ...props }) => (
        <div className="w-full text-gray-800 dark:text-gray-200" {...props}>{children}</div>
      ),
      p: ({ children, ...props }) => (
        <p 
      ...
      pre: ({ children, ...props }) => (
        <pre className="w-full p-4 rounded bg-gray-50 dark:bg-gray-800 my-4 overflow-x-auto" {...props}>
          {children}
        </pre>
      ),
...
const ConversationItem = ({ conv, index, isLatest }: { 
            ...
            <div className="flex gap-4 pb-4">
              {allVideos.map((video, index) => {
                ...
                return (
                  <div
                    key={index}
                    className="flex-shrink-0 w-[250px] bg-white dark:bg-gray-700 rounded-[8px] border shadow-sm overflow-hidden hover:shadow-md transition-shadow flex flex-col"
                  >
                    <a
                    ...
                    <div className="border-t bg-gray-50 dark:bg-gray-800">
                      <a
                        ...
                        target="_blank"
                        rel="noopener noreferrer"
                        className="p-3 flex items-center justify-center hover:bg-gray-100 dark:hover:bg-gray-700 transition-colors group"
                      >
                        <span className="text-sm font-medium text-gray-700 dark:text-gray-300 group-hover:text-gray-900">
                          Watch Full Video
                        </span>
                      </a>  
                    </div>
  ...
  return (
    <div ref={conversationRef} className="w-full bg-white dark:bg-gray-800 rounded-lg shadow-sm p-6 mb-4 mt-16 sm:mt-0">
      {/* Question Section */}
      <div className="mb-4 pb-4 border-b dark:border-gray-700">
        <div className="flex items-center gap-2">
          <p className="text-gray-800 dark:text-gray-200 break-words font-bold" style={{ fontFamily: systemFontFamily }}>
            {conv.question}
          </p>
        </div>
      </div>
...
// Update ProcessingCard component
const ProcessingCard = ({ 
  ...
  return (
    <div 
      ref={loadingCardRef} 
      className="w-full bg-white dark:bg-gray-800 rounded-lg p-4 mb-4 mt-16 sm:mt-0 shadow-sm transition-all duration-500 ease-in-out"
    >
        ...
        <div className="flex items-center justify-between border-b pb-3">
          <div className="flex items-center gap-2">
            <div className="relative w-8 h-8">
              <div className="absolute inset-0 bg-blue-50 rounded-full animate-ping opacity-40" />
            ...
            <div>
              <h2 className="text-sm font-medium text-gray-800 dark:text-gray-200">Processing Query</h2>
              <p className="text-xs text-gray-500 truncate max-w-[200px]">{query}</p>
            </div>
          </div>
            ...
            return (
              <div 
                ...
                className={cn(
                  ...
                  isComplete ? "border-green-200 dark:border-green-700 bg-green-50 dark:bg-green-900/30" : 
                  isCurrent ? "border-blue-200 dark:border-blue-700 bg-blue-50 dark:bg-blue-900/30" : 
              ...
              >
                <div className="flex items-center gap-2">
                  ...
                  >
                    {isComplete ? (
                      <svg 
                        className="w-3 h-3 text-white animate-scale-check" 
                        fill="none" 
                        viewBox="0 0 24 24" 
                        stroke="currentColor"
                      >
    ...
    <div className="relative">
      ...
      {isOpen && (
        <>
          ...
          />
          <div className="absolute right-0 mt-2 w-72 bg-white dark:bg-gray-800 rounded-lg shadow-lg border overflow-hidden z-50">
            <div className="p-2">
              <Button
                onClick={() => {
                  onNewConversation();
    ...
    <>
      {isOpen && (
        <div className="fixed inset-0 bg-black bg-opacity-50 z-50">
          <div className="fixed top-0 left-0 h-full w-80 bg-white dark:bg-black transform transition-transform duration-300 ease-in-out overflow-y-auto">
            <div className="p-6">
    ...
    <div className="relative w-full h-full bg-[#e6f3ff] dark:bg-black transition-colors duration-700 ease-in-out">
      <div className="absolute inset-0" 
        style={{
          ...
          opacity: '0.4',
          '--pattern-color': 'rgba(59, 130, 246, 0.1)', // Light blue pattern
      ...
      <div className="absolute inset-0"
        style={{
          ...
          '--grid-color': 'rgba(59, 130, 246, 0.07)', // Light blue grid
          transition: 'all 700ms cubic-bezier(0.4, 0, 0.2, 1)'
        } as React.CSSProperties}
      />
    </div>
...
// Add the AnimatedText component before the main ChatPage component
const AnimatedText = ({ texts, interval = 2000 }: AnimatedTextProps) => {
      ...
      <div className="relative" key="conversations-container">
        ...
        >
          ...
          {(isStreaming || isSecondResponseLoading) && messages.length > 0 && !currentConversation.find(conv => conv.question === processingQuery) && (
            <div key={`streaming-${messageId}`} className="w-full bg-white dark:bg-gray-800 rounded-lg shadow-sm p-6 mb-4 mt-16 sm:mt-0">
                    ...
                    <div className="bg-white dark:bg-gray-800 rounded-lg p-4 mb-4">
                      <div className="space-y-6">
                        ...
                        <div>
                          ...
                          <div className="flex overflow-x-auto space-x-4">
                            {[1, 2].map((i) => (
                              <div key={i} className="flex-none w-[280px] bg-white dark:bg-gray-700 border rounded-lg overflow-hidden">
                                <div className="aspect-video w-full bg-gray-200 animate-pulse" />
                                <div className="p-3">
                                  <div className="h-4 bg-gray-200 rounded animate-pulse mb-2" />
                                  <div className="h-4 bg-gray-200 rounded animate-pulse w-2/3" />
                        ...
                        <div>
                          ...
                          <div className="flex overflow-x-auto space-x-4">
                            {[1, 2, 3].map((i) => (
                              <div key={i} className="flex-none min-w-[180px] bg-white dark:bg-gray-700 border rounded-lg px-4 py-3">
                                <div className="h-4 bg-gray-200 rounded animate-pulse mb-2" />
                                <div className="h-4 bg-gray-200 rounded animate-pulse w-2/3" />
                              </div>
                            ))}
            ...
            <main className={cn(
              ...
              <div className="w-full mt-16 sm:mt-0">
                {currentConversation.length === 0 && showInitialQuestions && !isStreaming && !isLoading ? (
                  <div className="relative w-full min-h-[calc(100vh-200px)] flex flex-col items-center justify-center px-4">
                    ...
                    <div className="relative z-10 max-w-3xl w-full mx-auto space-y-12">
                      ...
                      <div className="text-center space-y-4 animate-fade-in">
                        <h1 className="text-4xl sm:text-5xl font-bold">
                          <span className="block">Curious about</span>
                          <span className="bg-clip-text text-[#179BD7] bg-gradient-to-r from-[#1a5f00] via-[#2f8c04] to-[#1a5f00]">
                      ...
                      {/* Enhanced Search Bar */}
                      <div className="w-full transform animate-float-up rounded-xl">
                        <SearchBar 
                          loading={isLoading}
                      ...
                      {/* Example Questions */}
                      <div className="w-full space-y-6 animate-fade-in-delayed">
                        <p className="text-center text-gray-500 text-sm uppercase tracking-wider font-medium">
                          Try asking
                        </p>
                        <div className="grid gap-3 grid-cols-1 sm:grid-cols-3 w-full max-w-4xl mx-auto">
                          {randomQuestions.slice(0, 3).map((question, index) => (
                            <button
                              key={index}
                            ...
                            >
                              <div className="absolute inset-0 bg-gradient-to-r from-[rgba(23,155,215,0.1)] to-transparent 
                                            opacity-0 group-hover:opacity-100 transition-opacity duration-300 
                                            rounded-xl" />
                              
                              <span className="relative z-10 block text-sm text-gray-800 dark:text-gray-300 text-left line-clamp-3 
  ...
  return (
    <div className="w-full py-3">
      <form 
        onSubmit={onSearch} 
        className={cn(
          "w-full flex items-center bg-white dark:bg-gray-800 py-1.5 rounded-xl",
      ...
      >
        ...
        <Textarea
          ...
          className={cn(
            ...
            "border-none",
            loading && "opacity-50",
            disabled && "bg-transparent dark:bg-transparent cursor-default"
          )}
          style={{
