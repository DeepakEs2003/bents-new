...
const Header = ({ 
  ...
  return (
    <header className={cn(
      "fixed top-0 left-0 right-0 bg-black z-50",
      pathname !== "/" && "border-b dark:border-white/30"
    )}>
      <div className="w-full px-4 sm:px-12">
          ...
          <div className="flex items-center gap-4">
            ...
            <Link href="/">
              <Image
                ...
                height={50}
                priority
                className="h-12 w-auto animate-lighting"
              />
            </Link>
          </div>
          ...
          <div className="flex items-center space-x-3 sm:space-x-6">
            ...
            {isLoaded && isSignedIn && pathname === '/chat' && (
              <button
                ...
                className="text-white hover:text-[#5a8ca3] transition-transform hover:scale-110 animate-bounce"
                title="Chat History"
              >
            ...
            {isLoaded && isSignedIn && (
              <Link 
                href="/chat" 
                className={cn(
                  "text-white hover:text-[rgba(23,155,215,255)] transition-transform hover:scale-110 animate-bounce",
        ...
        {isHistoryOpen && (
          <div className="fixed inset-0 bg-black bg-opacity-50 z-50">
            <div 
              ref={historyRef}
              className="fixed top-0 left-0 h-full w-80 bg-white dark:bg-gray-900 transform transition-transform duration-300 ease-in-out overflow-y-auto"
            >
              <div className="p-6">
